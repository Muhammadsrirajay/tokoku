            ...
            <form action="{{ url('update-products/'.$products->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea class="form-control" rows="3" name="meta_keyword">{{ $products->meta_keyword }}</textarea>
                    </div>
                    <div class="col-md-12 mb-3">
                    ...
                    @if($products->image)
                        <img src="{{ asset('assets/uploads/products/'.$products->image) }}" alt="products image" class="cate-image1">
                    @endif
                    <div class="col-md-12 mb-3">
